...
public:
	...
	LPDIRECTDRAWSURFACE7 SurfaceCreateWith16SPL(const char *szFileName, BOOL bUseVideoMemory, COLORREF crCK,BOOL bSetting);
	LPDIRECTDRAWSURFACE7 SurfaceCreateWithLib(const char *szFileName, int *LibOffset, BOOL bUseVideoMemory, COLORREF crCK,BOOL bSetting);
