...
public:
	...
	void						ConvertSurface16to32(CDDSurface* sourceSurface, CDDSurface* targetSurface);
	void						Flip();					//화면 Flip
...
public:
	...
	CDDSurface*					m_pWorkSurface;				//임시 작업용 Surf.
	CDDSurface*					m_pDrawSurface32;			//Drawing Surface 32 bit
