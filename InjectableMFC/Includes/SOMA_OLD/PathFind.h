...
#define MAX_PATH_X		100
#define MAX_PATH_Y		100
...
public:
	...
	void SetAllocedMap(int cx, int cy, MOVEINFO **map);
...
protected:
	...
	int			m_nSqrtTable[MAX_PATH_X][MAX_PATH_Y];
	int			m_nDistance;
#ifdef _DEBUG
	CDC *m_pDC;
	CSize m_vCell;
