...
public:
	...
	ITEM_STORAGE()
	{
		...
		m_vMinDamage = 0;
		m_vMaxDamage = 0;
		m_vIndex = m_vPicNum = m_vWeight = -1;
		m_vUsage = m_vMaxUsage = m_vOrgMaxUsage = 0;
		m_vName.Empty();
		for(int i = 0; i < 7; i++)
		{
...
//start defining rarity of item types
#define TYPE_NORMAL				0
#define TYPE_COMMON				20
#define TYPE_UNCOMMON			40
#define TYPE_RARE				60
...
#define MAGIC_TYPE_MAGIC 1
#define MAGIC_TYPE_SPECIAL 2
#define MAGIC_TYPE_ABILITY 3

#define ABILITY_REPAIR 1
#define ABILITY_DISASSEMBLE 2
#define ABILITY_SYNTHESIS 3
#define ABILITY_SMELT 4
#define ABILITY_PREPARE 5
#define ABILITY_UPGRADE 8
