...
public:
	...
	void TakeDonation(DWORD money);
	void RcvDonation(PBYTE bypData);
	void OpenGuild(PBYTE bypData);
	void EditGuildInfo(PBYTE bypData);
	void SendChangeGuildDesc(CString strDesc);
	void SendGuildSymbolChangeReq();
	void RcvGuildSymbolChangeReq(PBYTE bypData);
	void SendGuildSymbolChange();
	void RcvGuildSymbolChange(PBYTE bypData);
