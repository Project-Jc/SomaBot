...
{
public:
	CDialog_Login(CChildView *child_view, short nClass = 0);
...
public:
    ...
    short		m_nCreateClass;
	BYTE		m_bSkinCount;
	BYTE		m_bHairStyleCount;
	BYTE		m_bHairColorCount;
...
//	CTWFont			*m_pTWFont;
	...
	void SetCharData(int str, int dex, int iInt, int cha, int wis, int con);
