...
class	CDialog_GuildStorage;
class	CDialog_MakeItem;
class	CDialog_Ability;
class	CDialog_Exchange;
class	CDialog_GuildWar;
class	CDialog_RepairTrade;
...
class	CDialog_MapView;
class	CDialog_SelectInfo;
class	CDialog_QuestView;
class	CDialog_HelpList;
class	CDialog_HelpRead;
...
public:
	...
	CDialog_GuildStorage		*m_pDialog_GuildStorage;
	CDialog_MakeItem			*m_pDialog_MakeItem;
	CDialog_Ability				*m_pDialog_Ability;
	CDialog_Exchange			*m_pDialog_Exchange;
	CDialog_RepairTrade			*m_pDialog_RepairTrade;
	CDialog_GuildWar			*m_pDialog_GuildWar;
	...
	CDialog_GS_Buy				*m_pDialog_GS_Buy;
	...
	CDialog_MapView				*m_pDialog_MapView;
	CDialog_SelectInfo			*m_pDialog_SelectInfo;
	CDialog_QuestView			*m_pDialog_QuestView;
	CDialog_HelpList			*m_pDialog_Helplist;
